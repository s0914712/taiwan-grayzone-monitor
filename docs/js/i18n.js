...
const i18n = (function () {
    ...
    const dict = {
        ...
        'sts.map_title':         { zh: '📍 旁靠事件位置分布', en: '📍 Transfer Locations' },
        'sts.map_method':        { zh: '判定條件：距離 < 10m · 持續 ≥ 1 小時 · 排除港內', en: 'Criteria: distance < 10 m · duration ≥ 1 h · in-port excluded' },
        ...
        'vessel.coastguard':     { zh: '海警船', en: 'Coast Guard' },
        'vessel.msa':            { zh: '海巡(海事局)', en: 'MSA Patrol' },
        'vessel.rescue':         { zh: '海救(救助局)', en: 'Rescue & Salvage' },
        'vessel.research':       { zh: '科研/情報船', en: 'Research / Intel' },
        ...
        'idx.layer_dark':        { zh: '暗船 (SAR)', en: 'Dark Vessels (SAR)' },
        'idx.layer_routes':      { zh: '船隻航跡', en: 'Vessel Routes' },
        'idx.layer_baseline':    { zh: '領海基線/領海/鄰接區', en: 'Baseline / Territorial Sea / CZ' },
        'idx.layer_bathymetry':  { zh: '海床水深 (Seascape)', en: 'Bathymetry (Seascape)' },
        ...
        'idx.gov_none':          { zh: '近 48 小時無公務／科研船', en: 'No gov / research vessels in past 48h' },
        'idx.gov_last_seen':     { zh: '{0} 前', en: '{0} ago' },
        'unit.day':              { zh: '天', en: 'd' },
        'idx.gov_live':          { zh: '現正廣播', en: 'live' },
        'idx.gov_offline_n':     { zh: '{0} 艘已停播', en: '{0} offline' },
        'idx.gov_window':        { zh: '近 {0}h', en: 'past {0}h' },
        'idx.gov_formation':     { zh: '公務船編隊', en: 'Gov vessel formation' },
        'idx.gov_formation_escort': { zh: '🛡️ 護航科考', en: '🛡️ Escorted survey' },
        'idx.gov_formation_desc':{ zh: '{0} 艘同框 {1}h', en: '{0} vessels together for {1}h' },
        ...
        'dv.match_rematched':    { zh: '✅ 已比對到本地 AIS 船舶（假暗船）', en: '✅ Matched to local AIS vessel (false dark)' },
        'dv.match_residual':     { zh: '🔴 比對後仍無 AIS 訊號（殘餘暗船）', en: '🔴 Still dark after local AIS re-match' },
        'dv.match_nocover':      { zh: '⬜ 超出本地 AIS 留存範圍，無法驗證', en: '⬜ Outside local AIS retention — unverified' },
        'dv.match_infra':        { zh: '🏗 固定設施（風機／平台）', en: '🏗 Fixed infrastructure (wind farm / platform)' },
        'dv.infra_recurrence':   { zh: '跨過境日重現定位判定', en: 'flagged by cross-pass recurrence' },
        'dv.infra_mask':         { zh: '已知離岸風場遮罩命中', en: 'matched known offshore wind-farm mask' },
        'dv.match_unknown':      { zh: '⏳ 比對資料更新中（無本地比對記錄）', en: '⏳ Match data updating (no local record yet)' },
        'dv.chip_title':         { zh: '🛰️ SAR 切片取證:', en: '🛰️ SAR chip forensics:' },
        'dv.chip_confirmed':     { zh: '✅ 確認實體目標', en: '✅ Confirmed physical target' },
        'dv.chip_weak':          { zh: '🟡 弱目標', en: '🟡 Weak target' },
        'dv.chip_land':          { zh: '⚠️ 疑似陸地/固定結構', en: '⚠️ Likely land / fixed structure' },
        'dv.chip_none':          { zh: '⚪ 無目標（雜訊或低RCS）', en: '⚪ No target (noise / low RCS)' },
        'dv.chip_len':           { zh: '估計長度', en: 'Est. length' },
        'dv.chip_view':          { zh: '🔍 查看切片圖', en: '🔍 View SAR chip' },
        'dv.pos':                { zh: '位置:', en: 'Position:' },
        'dv.dist':               { zh: '距離:', en: 'Distance:' },
        'dv.pass':               { zh: '過境:', en: 'Pass:' },
        'dv.method':             { zh: '比對方法:', en: 'Method:' },
        'dv.method_interpolated': { zh: '內插', en: 'interpolated' },
        'dv.method_dead_reckoning': { zh: '航位推算', en: 'dead reckoning' },
        'dv.method_hold':        { zh: '駐留', en: 'hold' },
        'dv.chip_time':          { zh: '成像時刻:', en: 'Acquired:' },
        'dv.chip_product':       { zh: '產品:', en: 'Product:' },
        'dv.zone_internal_waters': { zh: '內水', en: 'Internal waters' },
        'dv.zone_territorial_sea': { zh: '領海 12nm', en: 'Territorial sea (12nm)' },
        'dv.zone_contiguous_zone': { zh: '鄰接區 24nm', en: 'Contiguous zone (24nm)' },
        'dv.zone_eez':           { zh: '專屬經濟區', en: 'EEZ' },
        'dv.zone_high_seas':     { zh: '公海', en: 'High seas' },
        ...
        'app.search':            { zh: '查詢', en: 'Search' },
        'app.type':              { zh: '類型:', en: 'Type:' },
        'app.coastguard':        { zh: '海警公務船', en: 'Coast Guard Vessel' },
        'app.msa':               { zh: '海巡公務船(海事局)', en: 'MSA Patrol Vessel' },
        'app.rescue':            { zh: '海救公務船(救助局)', en: 'Rescue & Salvage Vessel' },
        'app.research':          { zh: '科研/情報船', en: 'Research / Intel Vessel' },
        ...
        'app.last_seen':         { zh: '最後訊號:', en: 'Last seen:' },
        'app.ago_days':          { zh: '天前', en: 'd ago' },
        'app.ago_hours':         { zh: '小時前', en: 'h ago' },
        'app.stale_position':    { zh: '⚠️ 這是最後已知位置，不是即時位置', en: '⚠️ Last known position — not live' },
