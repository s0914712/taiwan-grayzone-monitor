...
| `statistics.html` | Historical trend charts (vessel counts, dark vessels, fishing effort). The region/flag distribution pies were **removed** (duplicated dark-vessels.html's richer table/list) — a link panel points there instead. | `ais_history.json` |
